...
<body>
    ...
    <div id="preloader-active">
        <div class="preloader d-flex align-items-center justify-content-center r">
            <div class="preloader-inner position-relative">
                <div class="preloader-circle"></div>
                <div class="preloader-img pere-text">
                    <img src="{{ asset('assets/img/logo/mindwave.png') }}" alt="Loading ....">
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="trend-top-img">
                                            ...
                                            <div class="trend-top-cap">
                                                ...
                                                <h2><a href="latest_news.html" data-animation="fadeInUp"
                                                        data-delay=".4s" data-duration="1000ms">Anna Lora Stuns In
                                                        White At Her Australian Premiere</a></h2>
                                                <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">
                                                    by Alice cloe - Jun 19, 2020</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link active" id="nav-home-tab"
                                                    ...
                                                    aria-controls="nav-home" aria-selected="true">Lifestyle</a>
                            ...
                            <div class="col-xl-12 ">
                                <div class="footer-copy-right text-center">
                                    <p>
                                        ...
                                        </script> All rights reserved by Firuz Ahmmed</a>
                                    </p>
                                </div>
                            </div>
                        </div>
